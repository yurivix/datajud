module.exports = async function handler(req, res) {
  ...
  // ── Format compact dates (20260504235834 → 2026-05-04T23:58:34) ──
  ...
  function formatHits(hits) {
    return (hits || []).map((hit) => {
      ...
      return {
        ...
        dataAjuizamento: fixDate(s.dataAjuizamento),
        dataUltimaAtualizacao: fixDate(s.dataHoraUltimaAtualizacao),
        grau: s.grau || "",
